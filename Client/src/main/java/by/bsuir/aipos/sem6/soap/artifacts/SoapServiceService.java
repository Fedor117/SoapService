 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://controller/", wsdlLocation = "http://localhost:9000/SoapService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://controller/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/SoapService?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://controller/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controller/", "SoapServicePort"), SoapService.class, features);
    }
